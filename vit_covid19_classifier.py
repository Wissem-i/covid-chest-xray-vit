...
Implementation for course assignment based on Vision Transformer research

This script implements a Vision Transformer (ViT) model for binary classification
of chest X-ray images to distinguish between COVID-19 and Pneumonia cases.

Based on research papers applying transformer architectures to medical imaging.
"""
